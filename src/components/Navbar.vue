<template>
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row border-bottom border-secondary">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch text-muted">
            <!-- <button class="navbar-toggler navbar-toggler align-self-center" type="button" data-toggle="minimize">
              <span class="mdi mdi-menu"></span>
            </button> -->
        
          <!-- <a class="sidebar-brand brand-logo p-2 ml-3" href="index.html"><img src="assets/images/zhivago-logo .png" alt="logo" height="50px" width="250px" /></a>
          -->
